...
import { ShoppingCart, Heart, Star, Filter, Search, Grid3X3, List, Minus, Plus } from 'lucide-react';
...
const Store = () => {
  ...
  const products = [
    ...
    },
    {
      ...
      reviews: 156,
      category: 'oleo',
      description: 'Finalização com brilho natural',
      inStock: true,
      isRecommended: false
    },
    {
      id: '4',
      name: 'Creme Para Pentear Cachos',
      brand: 'Curl Definition',
      price: 45.90,
      originalPrice: 55.90,
      image: '/lovable-uploads/62560d60-dd02-4d14-a219-49f2791caa7d.png',
      rating: 4.6,
      reviews: 78,
      category: 'creme',
      description: 'Define e controla o frizz dos cachos',
      inStock: false,
      isRecommended: false
    }
  ];
